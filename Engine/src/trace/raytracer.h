...
private:
    ...
    glm::vec3 ComputeBlinnPhong (const Ray& r, double t, glm::vec3 kd, glm::vec3 ks, glm::vec3 ke, glm::vec3 kt, float shininess, glm::vec3 N, TraceLight* tl, Camera* debug_camera);
    glm::vec3 ShadowAttenuation (Ray* r, TraceLight* tl, Camera* debug_camera);;
};
